...
contract FluffFlip is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Fluff Flip";
    string constant _symbol = "Fluff Flip";
    ...
    uint256 houseFee = 1;
    uint256 burnFee = 1;
    uint256 holdersFee = 1;
    uint256 sustainabilityFee = 1;
    ...
    function triggerFluffFlipBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
